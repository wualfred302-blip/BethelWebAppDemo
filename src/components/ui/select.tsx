...
function SelectTrigger({ className, onBlur, children }: SelectTriggerProps) {
  ...
  return (
    <button
      ...
      onBlur={onBlur}
      className={cn(
        'flex h-12 w-full items-center justify-between rounded-lg border-none bg-surface-container-highest px-4 text-sm text-left text-on-surface',
    ...
    >
      ...
      <svg
        className={cn(
          'ml-2 h-5 w-5 shrink-0 text-primary pointer-events-none transition-transform',
          open && 'rotate-180',
        )}
        fill="none"
        viewBox="0 0 24 24"
